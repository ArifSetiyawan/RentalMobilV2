...
<head>
  <meta charset="utf-8" />
  <title>Invoice Pembayaran Denda</title>
  ...
  <div class="invoice-box">
    <table cellpadding="0" cellspacing="0">
      ...
      <tr class="item">
        ...
        ?>
        <td><?= $jmlHari ?> X Rp. <?php echo number_format($data_trx['denda'], 0, ',', '.'); ?></td>
      </tr>

      <tr class="total">
        <td></td>

        <td>Total Denda : Rp. <?php echo number_format($data_trx['denda'] * $jmlHari, 0, ',', '.'); ?></td>
      </tr>
