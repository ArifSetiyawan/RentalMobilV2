          ...
          <div class="card-body">
            <form action="" method="post">
              <div class="row" style="justify-content: center;">
                ...
                <div class="col-md-2">
                  <div class="form-group mt-4 pt-2">
                    <a href="<?= base_url('report/printReportTransaksi/?dari=') . set_value('dari') . '&sampai=' . set_value('sampai') . '&status=' . set_value('status'); ?>" target="_blank" class="btn btn-info"><i class="fas fa-print"></i> Print Report</a>
                  </div>
                </div>
              </div>
            </form>
