                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $mobil['kode_type'] ?></td>
                                            <td><?php echo $mobil['nopol'] ?></td>
                                            <td><?php echo $mobil['kapasitas'] ?> orang</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() ?>masterdata/detailMobil/<?php echo sha1($mobil['Id_mobil']) ?>" class="btn btn-icon btn-info btn-sm" title="Detail">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="<?php echo base_url() ?>masterdata/edit_mobil/<?php echo sha1($mobil['Id_mobil']) ?>" class="btn btn-icon btn-success btn-sm" title="Edit">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <a href="#" class="btn btn-icon btn-danger btn-sm" title="Hapus" onclick="doDelete('<?php echo sha1($mobil['Id_mobil']) ?>')">
